...
_Next, I asked my brother, a data scientist which model he recommends, and he pointed me to logistic regression. It seems this model is a lot more complicated to use than the NB ones. I ran it with no settings, and it was getting ~= 80$ scores. I tried with 1000 iterations and it got up to 84% accuracy.
```{python}
